...
var vendedores = new Vendedores('André Luiz Gomes', 2000, 10000);
console.log(vendedores);
// console.log("Desconto de 8% do salario:", vendedores.desconto())
// try{
//     vendedores.nome = 'Marcos'
...
//     console.log(err.message)
// }
var pessoaFisica = new PessoaFisica('Leonardo', 1000, 30000, 'sul');
...
var pessoaJuridica = new PessoaJuridica('Pessoa Qualquer', 3000, 10000, 'TE Games', 120);
